...
translatable.prototype.updateItem = function (item, data, files, callback) {
	async.every(this.languages, function (language, callback) {
		var field = this.getSubField(language);
		if(field.type === 'file'){
			field.updateItem(item, data, files, callback);
		}else{
...
translatable.prototype.updateItemOld = function (item, data, callback) {
