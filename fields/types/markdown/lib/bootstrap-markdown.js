...
// Unfortunately, this library doesn't support target attr out of the box.
// So, we altered the link render. If a link has "!" at the beginning of href,
...
renderer.link = (href, title, text) => {
	const target = href[0] == '!';
    if (target) {
    	const html = linkRenderer.call(renderer, href.substring(1), title, text);
